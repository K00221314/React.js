...
//    @Path("{brand}")
//    @Produces({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
//    public Productdetails find(@PathParam("brand") String brand) {
//        return super.find(brand);
//    }
    ...
    public List<Productdetails> findTop10() {
        return super.findTop10();
    }
    ...
    @Override
    @Produces({"application/xml", "application/json"})
    public List<Productdetails> getBrand() {
